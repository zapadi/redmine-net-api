...
namespace xUnitTestredminenet45api
{
    ...
    public class IssueCategoryTests
    {
        ...
        {
            var issueCategories =
                fixture.Manager.GetObjects<IssueCategory>(new NameValueCollection {{RedmineKeys.PROJECT_ID, PROJECT_ID}});
        ...
        public void Should_Create_IssueCategory()
        {
            ...
            var savedIssueCategory = fixture.Manager.CreateObject(issueCategory, PROJECT_ID);
        ...
        {
            var issueCategory = fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_GET, null);
        ...
        {
            var issueCategory = fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_UPDATE, null);
            ...
            fixture.Manager.UpdateObject(ISSUE_CATEGORY_ID_TO_UPDATE, issueCategory);

            var updatedIssueCategory = fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_UPDATE, null);
        ...
        public void Should_Delete_IssueCategory()
        {
            var exception =
                (RedmineException)
                    Record.Exception(
                        () => fixture.Manager.DeleteObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_DELETE, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(
                () => fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_DELETE, null));
        }

        [Fact]
        public void Should_Compare_IssueCategories()
        {
            var issueCategory = fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_COMPARE, null);
            var issueCategoryToCompare = fixture.Manager.GetObject<IssueCategory>(ISSUE_CATEGORY_ID_TO_COMPARE, null);
