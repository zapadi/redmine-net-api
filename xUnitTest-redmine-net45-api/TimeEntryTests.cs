...
namespace xUnitTestredminenet45api
{
    ...
    public class TimeEntryTests
    {
        ...
        {
            var timeEntries = fixture.Manager.GetObjects<TimeEntry>(null);
        ...
        public void Should_Create_Time_Entry()
        {
            ...
            var savedTimeEntry = fixture.Manager.CreateObject(timeEntry);
        ...
        {
            var timeEntry = fixture.Manager.GetObject<TimeEntry>(TIME_ENTRY_ID, null);
        ...
        {
            var timeEntry = fixture.Manager.GetObject<TimeEntry>(TIME_ENTRY_ID, null);
            var timeEntryToCompare = fixture.Manager.GetObject<TimeEntry>(TIME_ENTRY_ID, null);
        ...
        {
            var timeEntry = fixture.Manager.GetObject<TimeEntry>(UPDATED_TIME_ENTRY_ID, null);
            ...
            fixture.Manager.UpdateObject(UPDATED_TIME_ENTRY_ID, timeEntry);

            var updatedTimeEntry = fixture.Manager.GetObject<TimeEntry>(UPDATED_TIME_ENTRY_ID, null);
        ...
        public void Should_Delete_Time_Entry()
        {
            var exception =
                (RedmineException)
                    Record.Exception(() => fixture.Manager.DeleteObject<TimeEntry>(DELETED_TIME_ENTRY_ID, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(() => fixture.Manager.GetObject<TimeEntry>(DELETED_TIME_ENTRY_ID, null));
        }
    }
}