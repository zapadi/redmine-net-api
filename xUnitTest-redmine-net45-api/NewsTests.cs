...
namespace xUnitTestredminenet45api
{
    ...
    public class NewsTests
    {
        ...
        {
            var news = fixture.Manager.GetObjects<News>(null);
        ...
        {
            var news = fixture.Manager.GetObjects<News>(new NameValueCollection {{RedmineKeys.PROJECT_ID, PROJECT_ID}});
        ...
        {
            var firstNews =
                fixture.Manager.GetPaginatedObjects<News>(new NameValueCollection
                {
                    {RedmineKeys.LIMIT, "1"},
                    {RedmineKeys.OFFSET, "0"}
                });
            var secondNews =
                fixture.Manager.GetPaginatedObjects<News>(new NameValueCollection
                {
