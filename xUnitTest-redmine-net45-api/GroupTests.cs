...
namespace xUnitTestredminenet45api
{
    ...
    public class GroupTests
    {
        ...
        {
            var groups = fixture.Manager.GetObjects<Group>(null);
        ...
        {
            var group = fixture.Manager.GetObject<Group>(GROUP_ID,
        ...
        public void Should_Add_Group()
        {
            ...
            var exception = (RedmineException) Record.Exception(() => savedGroup = fixture.Manager.CreateObject(group));
        ...
        {
            var group = fixture.Manager.GetObject<Group>(UPDATED_GROUP_ID,
                new NameValueCollection {{RedmineKeys.INCLUDE, RedmineKeys.USERS}});
            group.Name = UPDATED_GROUP_NAME;
            group.Users.Add(new GroupUser {Id = UPDATED_GROUP_USER_ID});

            fixture.Manager.UpdateObject(UPDATED_GROUP_ID, group);

            var updatedGroup = fixture.Manager.GetObject<Group>(UPDATED_GROUP_ID,
                new NameValueCollection {{RedmineKeys.INCLUDE, RedmineKeys.USERS}});
        ...
        {
            var exception =
                (RedmineException) Record.Exception(() => fixture.Manager.DeleteObject<Group>(DELETED_GROUP_ID, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(() => fixture.Manager.GetObject<Group>(DELETED_GROUP_ID, null));
        }

        [Fact]
        public void Should_Compare_Groups()
        {
            var firstGroup = fixture.Manager.GetObject<Group>(GROUP_ID,
                new NameValueCollection {{RedmineKeys.INCLUDE, RedmineKeys.MEMBERSHIPS + "," + RedmineKeys.USERS}});
            var secondGroup = fixture.Manager.GetObject<Group>(GROUP_ID,
                new NameValueCollection {{RedmineKeys.INCLUDE, RedmineKeys.MEMBERSHIPS + "," + RedmineKeys.USERS}});
