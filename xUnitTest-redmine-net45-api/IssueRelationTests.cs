...
namespace xUnitTestredminenet45api
{
    ...
    public class IssueRelationTests
    {
        ...
        public void Should_Add_Issue_Relation()
        {
            ...
            var savedRelation = fixture.Manager.CreateObject(relation, ISSUE_ID);
        ...
        {
            var relations =
                fixture.Manager.GetObjects<IssueRelation>(new NameValueCollection {{RedmineKeys.ISSUE_ID, ISSUE_ID}});
        ...
        {
            var relation = fixture.Manager.GetObject<IssueRelation>(RELATION_ID_TO_GET, null);
        ...
        {
            var relation = fixture.Manager.GetObject<IssueRelation>(RELATION_ID_TO_COMPARE, null);
            var relationToCompare = fixture.Manager.GetObject<IssueRelation>(RELATION_ID_TO_COMPARE, null);
        ...
        public void Should_Delete_Issue_Relation()
        {
            var exception =
                (RedmineException)
                    Record.Exception(() => fixture.Manager.DeleteObject<IssueRelation>(RELATION_ID_TO_DELETE, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(() => fixture.Manager.GetObject<IssueRelation>(RELATION_ID_TO_DELETE, null));
        }
    }
}