...
namespace xUnitTestredminenet45api
{
    ...
    public class ProjectTests
    {
        ...
        {
            var project = fixture.Manager.GetObject<Project>(PROJECT_IDENTIFIER, null);
        ...
        {
            var project = fixture.Manager.GetObject<Project>(PROJECT_IDENTIFIER, new NameValueCollection
            {
        ...
        public void Should_Get_Project_With_IssueCategories()
        {
            ...
            Assert.True(project.IssueCategories.Count == NUMBER_OF_ISSUE_CATEGORIES,
                "Issue categories count != " + NUMBER_OF_ISSUE_CATEGORIES);
        ...
        public void Should_Get_Project_With_EnabledModules()
        {
            ...
            Assert.True(project.EnabledModules.Count == NUMBER_OF_ENABLED_MODULES,
                "Enabled modules count != " + NUMBER_OF_ENABLED_MODULES);
        ...
        public void Should_Get_Project_With_All_Data()
        {
            var project = fixture.Manager.GetObject<Project>(PROJECT_IDENTIFIER, new NameValueCollection
            {
                {
                    RedmineKeys.INCLUDE,
                    string.Join(",", RedmineKeys.TRACKERS, RedmineKeys.ISSUE_CATEGORIES, RedmineKeys.ENABLED_MODULES)
                }
            });
        ...
        {
            IList<Project> projects = fixture.Manager.GetObjects<Project>(new NameValueCollection
            {
                {
                    RedmineKeys.INCLUDE,
                    string.Join(",", RedmineKeys.TRACKERS, RedmineKeys.ISSUE_CATEGORIES, RedmineKeys.ENABLED_MODULES)
        ...
        {
            var news =
                fixture.Manager.GetObjects<News>(new NameValueCollection {{RedmineKeys.PROJECT_ID, PROJECT_IDENTIFIER}});
        ...
        public void Should_Create_Projects()
        {
            ...
            var savedProject = fixture.Manager.CreateObject(project);
        ...
        {
            var project = fixture.Manager.GetObject<Project>(UPDATED_PROJECT_IDENTIFIER,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
                        RedmineKeys.TRACKERS + "," + RedmineKeys.ISSUE_CATEGORIES + "," + RedmineKeys.ENABLED_MODULES
                    }
                });
            ...
            fixture.Manager.UpdateObject(UPDATED_PROJECT_IDENTIFIER, project);

            var updatedProject = fixture.Manager.GetObject<Project>(UPDATED_PROJECT_IDENTIFIER,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
        ...
        public void Should_Delete_Project()
        {
            var exception =
                (RedmineException)
                    Record.Exception(() => fixture.Manager.DeleteObject<Project>(DELETED_PROJECT_IDENTIFIER, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(() => fixture.Manager.GetObject<Project>(DELETED_PROJECT_IDENTIFIER, null));
        }

        [Fact]
        public void Should_Compare_Projects()
        {
            var project = fixture.Manager.GetObject<Project>(PROJECT_IDENTIFIER,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
            ...
            var projectToCompare = fixture.Manager.GetObject<Project>(PROJECT_IDENTIFIER,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
