...
namespace xUnitTestredminenet45api
{
    ...
    public class UserTests
    {
        ...
        public void Should_Add_User()
        {
            ...
            var exception =
                (RedmineException) Record.Exception(() => savedRedmineUser = fixture.RedmineManager.CreateObject(user));
        ...
        public void Should_Add_User_To_Group()
        {
            ...
            var user = fixture.RedmineManager.GetObject<User>(USER_ID_FOR_GROUP,
        ...
        public void Should_Compare_Users()
        {
            ...
            var user = fixture.RedmineManager.GetObject<User>(USER_ID, parameters);
            var userToCompare = fixture.RedmineManager.GetObject<User>(USER_ID, parameters);
        ...
        public void Should_Delete_User()
        {
            var exc =
                (RedmineException)
                    Record.Exception(() => fixture.RedmineManager.DeleteObject<User>(USER_ID_TO_DELETE, null));
            Assert.Null(exc);
        ...
        {
            IList<User> users =
                fixture.RedmineManager.GetObjects<User>(new NameValueCollection
                {
                    {RedmineKeys.INCLUDE, RedmineKeys.GROUPS + "," + RedmineKeys.MEMBERSHIPS}
                });
        ...
        {
            var user = fixture.RedmineManager.GetObject<User>(USER_ID, null);
        ...
        {
            var user = fixture.RedmineManager.GetObject<User>(USER_ID,
        ...
        {
            var user = fixture.RedmineManager.GetObject<User>(USER_ID_TO_UPDATE, null);
            user.FirstName = USER_FIRST_NAME_UPDATED;
            fixture.RedmineManager.UpdateObject(USER_ID_TO_UPDATE, user);

            var updatedUser = fixture.RedmineManager.GetObject<User>(USER_ID_TO_UPDATE, null);
