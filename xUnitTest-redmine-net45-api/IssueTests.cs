...
namespace xUnitTestredminenet45api
{
    ...
    public class IssueTests
    {
        ...
        {
            var issues = fixture.Manager.GetObjects<Issue>(null);
        ...
        {
            var issues =
                fixture.Manager.GetPaginatedObjects<Issue>(new NameValueCollection
                {
                    {RedmineKeys.OFFSET, OFFSET.ToString()},
                    {RedmineKeys.LIMIT, NUMBER_OF_PAGINATED_ISSUES.ToString()},
                    {"sort", "id:desc"}
                });

            Assert.NotNull(issues.Objects);
            Assert.All(issues.Objects, i => Assert.IsType<Issue>(i));
            Assert.True(issues.Objects.Count <= NUMBER_OF_PAGINATED_ISSUES,
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection {{RedmineKeys.PROJECT_ID, PROJECT_ID}});
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection {{RedmineKeys.SUBPROJECT_ID, SUBPROJECT_ID}});
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection
                {
                    {RedmineKeys.PROJECT_ID, PROJECT_ID},
                    {RedmineKeys.SUBPROJECT_ID, ALL_SUBPROJECTS}
                });
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection {{RedmineKeys.TRACKER_ID, TRACKER_ID}});
        ...
        {
            var issues = fixture.Manager.GetObjects<Issue>(new NameValueCollection {{RedmineKeys.STATUS_ID, STATUS_ID}});
            Assert.NotNull(issues);
            Assert.All(issues, i => Assert.IsType<Issue>(i));
        }
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection {{RedmineKeys.ASSIGNED_TO_ID, ASSIGNED_TO_ID}});
        ...
        {
            var issues =
                fixture.Manager.GetObjects<Issue>(new NameValueCollection {{CUSTOM_FIELD_NAME, CUSTOM_FIELD_VALUE}});
        ...
        {
            var issue = fixture.Manager.GetObject<Issue>(ISSUE_ID,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
                        RedmineKeys.CHILDREN + "," + RedmineKeys.ATTACHMENTS + "," + RedmineKeys.RELATIONS + "," +
                        RedmineKeys.CHANGESETS + "," + RedmineKeys.JOURNALS + "," + RedmineKeys.WATCHERS
                    }
                });
        ...
        public void Should_Add_Issue()
        {
            ...
            var savedIssue = fixture.Manager.CreateObject(issue);
        ...
        {
            var issue = fixture.Manager.GetObject<Issue>(UPDATED_ISSUE_ID,
                new NameValueCollection {{"include", "children,attachments,relations,changesets,journals,watchers"}});
            ...
            if (issue.CustomFields != null)
                ...
                {
                    Id = UPDATED_ISSUE_CUSTOM_FIELD_ID,
                    Values = new List<CustomFieldValue> {new CustomFieldValue {Info = UPDATED_ISSUE_CUSTOM_FIELD_VALUE}}
                });
            ...
            fixture.Manager.UpdateObject(UPDATED_ISSUE_ID, issue);

            var updatedIssue = fixture.Manager.GetObject<Issue>(UPDATED_ISSUE_ID,
                new NameValueCollection {{"include", "children,attachments,relations,changesets,journals,watchers"}});
        ...
        {
            var exception =
                (RedmineException) Record.Exception(() => fixture.Manager.DeleteObject<Issue>(DELETED_ISSUE_ID, null));
            Assert.Null(exception);
            Assert.Throws<NotFoundException>(() => fixture.Manager.GetObject<Issue>(DELETED_ISSUE_ID, null));
        }

        [Fact]
        public void Should_Add_Watcher_To_Issue()
        {
            fixture.Manager.AddWatcherToIssue(WATCHER_ISSUE_ID, WATCHER_USER_ID);

            var issue = fixture.Manager.GetObject<Issue>(WATCHER_ISSUE_ID.ToString(),
            ...
            Assert.True(((List<Watcher>) issue.Watchers).Find(w => w.Id == WATCHER_USER_ID) != null,
                "Watcher was not added.");
        }

        [Fact]
        public void Should_Remove_Watcher_From_Issue()
        {
            fixture.Manager.RemoveWatcherFromIssue(WATCHER_ISSUE_ID, WATCHER_USER_ID);
            ...
            Assert.NotNull(issue);
            Assert.True(
                issue.Watchers == null || ((List<Watcher>) issue.Watchers).Find(w => w.Id == WATCHER_USER_ID) == null,
                "Watcher was not removed.");
        }
        ...
        public void Should_Compare_Issues()
        {
            ...
            var issueToCompare = fixture.Manager.GetObject<Issue>(ISSUE_ID,
                new NameValueCollection
                {
                    {
                        RedmineKeys.INCLUDE,
