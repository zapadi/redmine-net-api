...
namespace Padi.DotNet.RedmineAPI.Integration.Tests.Tests.Entities;
...
public class UploadTestsAsync(RedmineTestContainerFixture fixture)
{
    ...
    public async Task Upload_Attachment_To_Issue_Should_Succeed()
    {
        ...
        var issue = await fixture.RedmineManager.CreateAsync(new Redmine.Net.Api.Types.Issue()
        {
        ...
        var files = await fixture.RedmineManager.GetAsync<Redmine.Net.Api.Types.Issue>(issue.Id.ToInvariantString(), RequestOptions.Include(RedmineKeys.ATTACHMENTS));
