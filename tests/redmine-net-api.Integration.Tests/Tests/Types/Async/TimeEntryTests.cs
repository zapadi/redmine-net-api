...
public class TimeEntryTestsAsync(RedmineTestContainerFixture fixture)
{
    ...
    public async Task CreateTimeEntry_Should_Succeed()
    {
        ...
        //Act
        var createdTimeEntry = await fixture.RedmineManager.CreateAsync(timeEntryData, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task GetTimeEntry_Should_Succeed()
    {
        ...
        //Act
        var retrievedTimeEntry = await fixture.RedmineManager.GetAsync<TimeEntry>(createdTimeEntry.Id.ToInvariantString(), cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdateTimeEntry_Should_Succeed()
    {
        ...
        //Act
        await fixture.RedmineManager.UpdateAsync(createdTimeEntry.Id.ToInvariantString(), createdTimeEntry, cancellationToken: TestContext.Current.CancellationToken);
        var retrievedTimeEntry = await fixture.RedmineManager.GetAsync<TimeEntry>(createdTimeEntry.Id.ToInvariantString(), cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task DeleteTimeEntry_Should_Succeed()
    {
        ...
        //Act
        await fixture.RedmineManager.DeleteAsync<TimeEntry>(timeEntryId, cancellationToken: TestContext.Current.CancellationToken);

        //Assert
        var ex = await Assert.ThrowsAsync<RedmineApiException>(() => fixture.RedmineManager.GetAsync<TimeEntry>(timeEntryId, cancellationToken: TestContext.Current.CancellationToken));
