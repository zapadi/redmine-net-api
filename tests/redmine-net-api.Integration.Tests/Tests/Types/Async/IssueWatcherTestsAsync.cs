...
public class IssueWatcherTestsAsync(RedmineTestContainerFixture fixture)
{
    ...
    public async Task AddWatcher_Should_Succeed()
    {
        ...
        // Act
        await fixture.RedmineManager.AddWatcherToIssueAsync(issue.Id, userId, cancellationToken: TestContext.Current.CancellationToken);
        
        // Get updated issue with watchers
        var updatedIssue = await fixture.RedmineManager.GetAsync<Issue>(issue.Id.ToString(), RequestOptions.Include("watchers"), TestContext.Current.CancellationToken);
    ...
    public async Task RemoveWatcher_Should_Succeed()
    {
        ...
        // Act
        await fixture.RedmineManager.RemoveWatcherFromIssueAsync(issue.Id, userId, cancellationToken: TestContext.Current.CancellationToken);
