...
public class JournalTestsAsync(RedmineTestContainerFixture fixture)
{
    ...
    public async Task Get_Issue_With_Journals_Should_Succeed()
    {
        ...
        await fixture.RedmineManager.UpdateAsync(issueIdToTest, testIssue, cancellationToken: TestContext.Current.CancellationToken);
        
        //Act
        var issueWithJournals = await fixture.RedmineManager.GetAsync<Issue>(issueIdToTest, RequestOptions.Include(RedmineKeys.JOURNALS), TestContext.Current.CancellationToken);
