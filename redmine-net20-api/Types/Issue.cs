	...
	public class Issue : Identifiable<Issue>, IXmlSerializable, IEquatable<Issue>, ICloneable
	{
		...
		public object Clone ()
		{
			var issue = new Issue {
				...
				Author = Author,
				Category = Category,
				CustomFields = CustomFields.Clone<IssueCustomField> (),
				...
				Notes = Notes,
				Watchers = Watchers.Clone<Watcher>()
			};
			return issue;
		}
		...
		public override int GetHashCode ()
		{
			...
			hashCode = Category.GetHashCode (hashCode);

			hashCode = Subject.GetHashCode (hashCode);
			hashCode = Description.GetHashCode (hashCode);
			hashCode = StartDate.GetHashCode (hashCode);
			hashCode = Project.GetHashCode (hashCode);
			hashCode = DueDate.GetHashCode (hashCode);
			hashCode = DoneRatio.GetHashCode (hashCode);

			hashCode = PrivateNotes.GetHashCode (hashCode);
			hashCode = EstimatedHours.GetHashCode (hashCode);
			hashCode = SpentHours.GetHashCode (hashCode);
			hashCode = CreatedOn.GetHashCode (hashCode);
			hashCode = UpdatedOn.GetHashCode (hashCode);

			hashCode = Notes.GetHashCode (hashCode);
			hashCode = AssignedTo.GetHashCode (hashCode);
			hashCode = ParentIssue.GetHashCode (hashCode);
			hashCode = FixedVersion.GetHashCode (hashCode);
			hashCode = IsPrivate.GetHashCode (hashCode);
			hashCode = Journals.GetHashCode (hashCode);
			hashCode = CustomFields.GetHashCode (hashCode);

			hashCode = Changesets.GetHashCode (hashCode);
			hashCode = Attachments.GetHashCode (hashCode);
			hashCode = Relations.GetHashCode (hashCode);
			hashCode = Children.GetHashCode (hashCode);
			hashCode = Uploads.GetHashCode (hashCode);
			hashCode = Watchers.GetHashCode (hashCode);
