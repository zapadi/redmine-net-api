...
namespace Redmine.Net.Api.Types
{
    ...
    public class Group : IdentifiableName, IEquatable<Group>
    {
        ...
        {
            return string.Format("[Group: Id={0}, Name={1}, Users={2}, CustomFields={3}, Memberships={4}]", Id, Name,
                Users, CustomFields, Memberships);
        }
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (!reader.EOF)
            {
                ...
                switch (reader.Name)
                {
                    ...
                    case RedmineKeys.USERS:
                        Users = reader.ReadElementContentAsCollection<GroupUser>();
                        break;
