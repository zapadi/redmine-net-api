...
/// </summary>
/// <summary>
/// Defines the contract for Redmine API serializers
/// </summary>
public interface IRedmineSerializer
{
    ...
    /// <summary>
    /// Gets the MIME type for this serializer (e.g. "application/json", "application/xml")
    /// </summary>
    ...
    /// <returns></returns>
    string SerializeUserId(int userId);
}