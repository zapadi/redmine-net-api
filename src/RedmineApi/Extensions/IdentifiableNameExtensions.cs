...
public static class IdentifiableNameExtensions
{
    ...
    /// <exception cref="ArgumentException">Thrown when the given value is less than or equal to zero.</exception>
    ...
    /// <exception cref="ArgumentException">Thrown when the specified value is less than or equal to zero.</exception>
