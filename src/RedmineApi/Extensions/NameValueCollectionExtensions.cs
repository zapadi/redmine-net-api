...
public static class NameValueCollectionExtensions
{
    ...
    /// <param name="key">The key to add if the condition is true.</param>
    /// <param name="value">The value to add if the condition is true.</param>
    ...
    /// </summary>
    /// <param name="collection">The NameValueCollection to add to.</param>
    /// <param name="key">The key to add if the value is not null.</param>
