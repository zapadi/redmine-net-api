...
internal sealed class RedmineApiUrls
{
    ...
    public static string TypeFragment(Dictionary<Type, string> mapTypeUrlFragments, Type type)
    {
        ...
        {
            throw new RedmineException(RedmineApiErrorCode.ArgumentInvalid, $"There is no uri fragment defined for type {type.Name}");
        }
    ...
    internal string PatchFragment(Type type, string ownerId)
    {
        ...
        throw new RedmineException(RedmineApiErrorCode.ArgumentInvalid, $"No endpoint defined for type {type} for PATCH operation.");
    }
