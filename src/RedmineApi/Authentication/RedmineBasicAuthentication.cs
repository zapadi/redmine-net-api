...
public sealed class RedmineBasicAuthentication: IRedmineAuthentication
{
    ...
    {
        if (username == null) throw new RedmineException(RedmineApiErrorCode.ArgumentInvalid, nameof(username));
        if (password == null) throw new RedmineException(RedmineApiErrorCode.ArgumentInvalid, nameof(password));
