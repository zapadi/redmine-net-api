...
public sealed class ConsoleTraceListener : TraceListener
{
	...
	/// </summary>
	/// <param name="eventCache">A <see>
	///         <cref>T:System.Diagnostics.TraceEventCache</cref>
	///     </see>
	///     object that contains the current process ID, thread ID, and stack trace information.</param>
	/// <param name="source">A name used to identify the output, typically the name of the application that generated the trace event.</param>
	/// <param name="eventType">One of the <see>
	///         <cref>T:System.Diagnostics.TraceEventType</cref>
	///     </see>
