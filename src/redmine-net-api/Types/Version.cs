...
namespace Redmine.Net.Api.Types
{
    ...
    public sealed class Version : Identifiable<Version>
    {
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (!reader.EOF)
            {
                switch (reader.Name)
                {
                    ...
                    case RedmineKeys.SHARING: Sharing = EnumHelper.Parse<VersionSharing>(reader.ReadElementContentAsString(), true); break;
                    case RedmineKeys.STATUS: Status = EnumHelper.Parse<VersionStatus>(reader.ReadElementContentAsString(), true); break;
        ...
        public override void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteElementString(RedmineKeys.STATUS, Status.ToLowerInvariant());
            if (Sharing != VersionSharing.Unknown)
            {
                writer.WriteElementString(RedmineKeys.SHARING, Sharing.ToLowerInvariant());
            }
        ...
        public override void ReadJson(JsonReader reader)
        {
            while (reader.Read())
            {
                ...
                switch (reader.Value)
                {
                    ...
                    case RedmineKeys.PROJECT: Project = new IdentifiableName(reader); break;
                    case RedmineKeys.SHARING: Sharing = EnumHelper.Parse<VersionSharing>(reader.ReadAsString(), true); break;
                    case RedmineKeys.STATUS: Status = EnumHelper.Parse<VersionStatus>(reader.ReadAsString(), true); break;
        ...
        public override void WriteJson(JsonWriter writer)
        {
            using (new JsonObject(writer, RedmineKeys.VERSION))
            {
                ...
                writer.WriteProperty(RedmineKeys.STATUS, Status.ToLowerInvariant());
                writer.WriteProperty(RedmineKeys.SHARING, Sharing.ToLowerInvariant());
