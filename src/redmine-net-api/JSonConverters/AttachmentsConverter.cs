...
namespace Redmine.Net.Api.JSonConverters
{
    internal class AttachmentsConverter : JavaScriptConverter
    {
        ...
        /// </summary>
        /// <param name="dictionary">An <see cref="System.Collections.Generic.IDictionary{TKey, TValue}" /> instance of property data stored as name/value pairs.</param>
        ...
        public override IDictionary<string, object> Serialize(object obj, JavaScriptSerializer serializer)
        {
            ...
            if (entity != null)
            {
                foreach (var entry in entity)
                {
                    ...
                    result.Add(entry.Key.ToString(CultureInfo.InvariantCulture), attachment.First().Value);
                }
            }
