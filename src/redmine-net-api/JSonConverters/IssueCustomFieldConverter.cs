            ...
            if (dictionary != null)
            {
                ...
                if (val != null)
                {
                    ...
                    if (list != null)
                    {
                        ...
                        {
                            customField.Values.Add(new CustomFieldValue {Info = Convert.ToString(value, CultureInfo.InvariantCulture)});
                        }
                    }
                    else
                    {
                        customField.Values.Add(new CustomFieldValue {Info = Convert.ToString(val, CultureInfo.InvariantCulture)});
                    }
                }
                return customField;
            }
